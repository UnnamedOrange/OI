...
&emsp;&emsp;对于以上内容，你可以以二维向量为例，结合你在数学课上学的向量进行理解。
...
&emsp;&emsp;第 $j$ 步：若 $\vec {a_j} \in \mathrm{span}(\vec{a_1}, \cdots, \vec{a_{j - 1}})$，则从 $B$ 中去掉 $\vec{a_j}$，否则保持 $B$ 不变。
...
&emsp;&emsp;对于这道题，我们可以用线性基合并，结合 ST 表解决。
